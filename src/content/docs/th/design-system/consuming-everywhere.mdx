...
นี่คือผลตอบแทนของการเลือก custom element เป็น shared-UI layer ของ Mosaic ที่แนะนำครั้งแรกใน [Web Components Interop →](/mosaic/th/web-components/) ตรงนี้เราพิสูจน์ให้เห็นครบตั้งแต่ต้นจนจบ
...
Astro ship client JS เป็นศูนย์โดย default เราจึง register primitive ใน module `<script>` tag render เป็น HTML ธรรมดาบน server แล้วนิยาม custom-element ค่อย upgrade ให้บน client นี่คือ WC bundle เดียวกับที่ Astro expose สำหรับ path การ compose (ดู [Composing SSR →](/mosaic/th/content/composing-ssr/))
