...
Extend the health-check `app.ts` from [The BFF stack](/mosaic/en/setup/the-bff-stack/) with the two product routes. `server.ts` doesn't change — it already imports this `app` and serves it on 4001.
